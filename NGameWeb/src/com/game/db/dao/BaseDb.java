...
public interface BaseDb {
	...
	public List<Map<String, Object>> limit(@Param("table") String table,@Param("offset") String offset,@Param("rows") String rows);
	
	public int count(@Param("table") String table);
